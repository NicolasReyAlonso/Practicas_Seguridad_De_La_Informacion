...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\textcolor{darkblue}{Práctica 8: Informe sobre noticias en prensa relativas a amenazas informáticas}}
...
\title{
    ...
    {\rule{\textwidth}{2pt}}\\
    \vspace{0.5cm}
    {\LARGE \textbf{SI -- CURSO 2025-2026 -- PRÁCTICA 8 -- NICOLÁS REY ALONSO}}\\
    \vspace{0.5cm}
    {\Large \textbf{INFORME SOBRE NOTICIAS EN PRENSA RELATIVAS A AMENAZAS INFORMÁTICAS}}\\
    \vspace{0.5cm}
    {\rule{\textwidth}{2pt}}\\
    \vspace{1cm}
