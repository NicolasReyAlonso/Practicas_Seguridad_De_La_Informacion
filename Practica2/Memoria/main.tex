...
\begin{itemize}[label=\textbullet]
    ...
    \item \textbf{Imágenes comprimidas:} No funcionan bien con el experimento ECB y la primera vez guardé la imagen
     cifrada en formato JPEG, lo que hizo que no se apreciaran los patrones. La solución fue convertir a PGM, cifrar, y luego convertir 
     de nuevo a PNG.
\end{itemize}
...
\bibitem{openssl_docs} OpenSSL Documentation, \url{https://www.openssl.org/docs/man3.2/}, 2024.
