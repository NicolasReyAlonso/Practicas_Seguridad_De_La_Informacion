...
\author{
    \textbf{Autor:} \\
    Nicolás Rey Alonso\\
    \texttt{nicolasrey.alonso@estudiantesulpgc.es}\\
    \vspace{1cm}
    \textbf{Profesor:} \\
    Nombre del Profesor\\
}
...
El objetivo principal de esta práctica es familiarizarse con el uso de \textit{OpenSSL} para realizar operaciones criptográficas utilizando:
...
\begin{itemize}[label=\textbullet]
    \item OpenSSL versión 3 o superior
    \item Provider Legacy activado
    \item ImageMagick (para la parte 2.3)
    \item Conocimiento básico de línea de comandos
\end{itemize}

\section{Organización del informe}

Este informe está organizado en las siguientes secciones:

\begin{enumerate}
    \item \textbf{Sección 2.1:} Generación y comprobación de resúmenes
    \item \textbf{Sección 2.2:} Cifrado simétrico de documentos
    \item \textbf{Sección 2.3:} Demostración de la peligrosidad del modo ECB
    \item \textbf{Conclusiones:} Análisis de resultados y conclusiones finales
\end{enumerate}

%% ============================================================================
%% CAPÍTULO 2: GENERACIÓN Y COMPROBACIÓN DE RESÚMENES
%% ============================================================================
...
Los algoritmos de resumen (\textit{hash}) son funciones criptográficas que transforman un documento de cualquier tamaño en una cadena de longitud fija, denominada \textit{hash} o \textit{resumen}. Las principales características son:

\begin{itemize}[label=\textbullet]
    \item \textbf{Determinismo:} El mismo entrada siempre produce la misma salida
    \item \textbf{Eficiencia:} Se calcula rápidamente
    \item \textbf{Dependencia:} Cambios mínimos en la entrada producen cambios drásticos en la salida
    \item \textbf{Inyectividad aproximada:} Es computacionalmente imposible encontrar dos entradas con el mismo hash
    \item \textbf{Unidireccionalidad:} Es imposible recuperar la entrada a partir del hash
\end{itemize}
...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{l|c|c|p{5cm}}
        ...
        \midrule
        MD5 & 128 & 16 & Obsoleto, no usar en producción \\
        SHA-1 & 160 & 20 & Débil, deprecado \\
        SHA-256 & 256 & 32 & Recomendado, parte de SHA-2 \\
...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{l|X}
        ...
        \midrule
        MD5 & \texttt{\small [Insertar resultado]} \\
        SHA-1 & \texttt{\small [Insertar resultado]} \\
        SHA-256 & \texttt{\small [Insertar resultado]} \\
        SHA-512 & \texttt{\small [Insertar resultado]} \\
        Whirlpool & \texttt{\small [Insertar resultado]} \\
        \bottomrule
    \end{tabularx}
\end{table}
...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{l|X}
        ...
        \midrule
        Archivo original & \texttt{\small [Insertar resultado]} \\
        Con un carácter modificado & \texttt{\small [Insertar resultado]} \\
        \bottomrule
    \end{tabularx}
\end{table}
