...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{l|c|c|p{5cm}}
        ...
        \midrule
        MD5 & 128 & 16 & Desfasado \\
        SHA-1 & 160 & 20 & Débil \\
        SHA-256 & 256 & 32 & Usado en la actualidad \\
        SHA-512 & 512 & 64 & Sucesor de SHA-256, muy seguro \\
...
Se utilizará un archivo de texto plano de 170 caracteres con contenido legible y sin caracteres especiales para facilitar la 
...
Los tamaños de los resúmenes coinciden con las especificaciones técnicas:
