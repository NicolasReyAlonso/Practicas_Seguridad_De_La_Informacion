...
\begin{figure}[H]
    ...
    \caption{Ejecución del cifrado con aes-256-cbc, listado de los ficheros generados y verificación de su contenido y tamaño}
    \label{fig:cifrados_simetricos}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{imagenes/screenshots/cifrado/cifrardescifrariv.png}
    \caption{Cifrado, extracción de la sal y posterior descifrado con clave e IV explícitos}
    \label{fig:cifrado_descifrado_iv}
\end{figure}
