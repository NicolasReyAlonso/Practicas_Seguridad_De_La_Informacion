...
\begin{itemize}[label=\textbullet]
    \item \textbf{Formatos binarios:} Importancia de usar \texttt{-binary} en OpenSSL
     para evitar problemas de codificación cundo se requiere un formato específico.
...
\bibitem{ecb_danger} Wikipedia, \textit{Block cipher mode of operation}, \url{https://en.wikipedia.org/wiki/Block_cipher_mode_of_operation}, 2024.

\bibitem{tux} Wikipedia, \textit{Electronic Codebook (ECB) - Tux the Linux Penguin}, \url{https://en.wikipedia.org/wiki/Block_cipher_mode_of_operation#ECB}, 2024.

\bibitem{claude} Claude, \textit{Inteligencia Artificial}, \textit{\url{https://claude.ai/}} , 2024.
