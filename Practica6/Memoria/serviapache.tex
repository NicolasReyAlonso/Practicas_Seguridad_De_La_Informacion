...
\begin{figure}[h!] % Define un entorno flotante para la figura
...
\begin{figure}[h!] % Define un entorno flotante para la figura
    ...
    \caption{Comprobación de la configuración de Apache.} 
    
    \label{fig:imagen_12} % Etiqueta para poder referenciarla más tarde
\end{figure}
