...
\textbf{1.3 - Decodificación con la utilidad ``openssl smime'' del mensaje cifrado y firmado que recibimos del compañero}
...
\textbf{Nota importante:} El parámetro \texttt{-recip} requiere el certificado en formato PEM (\texttt{.crt}), \textbf{no} el fichero PKCS\#12 (\texttt{.p12}). Si solo se dispone del \texttt{.p12}, hay que extraer primero el certificado y la clave.
