...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\textcolor{darkblue}{Práctica 10: MECANISMOS DE DEFENSA EN NUESTRO ENTORNO DOMÉSTICO}}
...
\title{
    ...
    {\rule{\textwidth}{2pt}}\\
    \vspace{0.5cm}
    {\LARGE \textbf{Práctica 10:}}\\
    {\LARGE \textbf{MECANISMOS DE DEFENSA EN NUESTRO ENTORNO DOMÉSTICO}}\\
    \vspace{0.5cm}
    {\rule{\textwidth}{2pt}}\\
    \vspace{1cm}
...
\newcommand{\campo}[1]{\vspace{0.2cm}\noindent\textbf{#1}: \underline{\hspace{8cm}} \\ \vspace{0.3cm}}
