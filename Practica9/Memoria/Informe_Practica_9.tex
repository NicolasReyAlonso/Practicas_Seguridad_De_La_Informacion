...
\title{
    ...
    {\rule{\textwidth}{2pt}}\\
    \vspace{0.5cm}
    {\LARGE \textbf{SI --- CURSO 2025-2026 --- PRÁCTICA 9 --- NICOLÁS REY ALONSO}}\\
    \vspace{0.5cm}
    {\Large \textbf{ANÁLISIS COMPARATIVO DE VULNERABILIDADES:}}\\
    \vspace{0.3cm}
    {\Large \textbf{CVE-2018-6350 \,-\, CVE-2025-53766 \,-\, CVE-2023-51582}}\\
    \vspace{0.5cm}
    {\rule{\textwidth}{2pt}}\\
    \vspace{1cm}
