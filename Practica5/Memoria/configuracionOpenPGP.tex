...
S/MIME de la parte 2 … pero no lo aconsejamos, ya, el programa Thunderbird permite
...
activadas las claves OpenPGP para la cuenta seleccionada. Es importante asegurarnos de que NO hemos activado el cifrado por defecto ni el envío de firmas de manera
predeterminada,
