...
En lineas generales, haber realizado correctamente las prácticas anteriores.
\begin{itemize}
...
\begin{itemize}
    \item Modificar la configuración del servidor web Apache para que acepte certificados de cliente firmados por la misma autoridad de certificación y por una autoridad adicional (FNMT).
