...
A diferencia del cifrado simétrico (donde emisor y receptor comparten la misma clave), la criptografía asimétrica utiliza un \textbf{par 
de claves} matemáticamente relacionadas:
