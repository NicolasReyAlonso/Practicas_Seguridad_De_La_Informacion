...
\begin{figure}[H]
    ...
    \caption{Ejecución de la generación de la clave privada RSA de 2048 bits protegida}
    \label{fig:generacion_rsa}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Exportación de la clave pública a formato PEM}
    \label{fig:exportar_rsa_pub}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Exportación a DER, reconversión a PEM y comprobación de ausencia de contraseña}
    \label{fig:rsa_der_pem}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Proceso de cálculo de resumen, firma y verificación con RSA exitosa}
    \label{fig:firma_rsa}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Ejecución de todo el proceso de generación, exportación, conversión, firma y verificación con DSA}
    \label{fig:proceso_dsa}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Generación de las claves públicas y comprobación de igualdad en el secreto derivado (DH)}
    \label{fig:derivacion_dh}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Ejecución de la generación y comprobación de igualdad del secreto compartido usando curva elíptica X25519}
    \label{fig:derivacion_x25519}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Verificación de tamaño de los ficheros binarios de los secretos para DH y X25519}
    \label{fig:comparacion_tamanios_secretos}
\end{figure}
